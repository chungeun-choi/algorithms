...
if __name__ == "__main__":
    test_input = {"maps": ["SOOOL", "XXXXO", "OOOOO", "OXXXX", "OOOOE"]}

    test_input2 = {"maps": ["LOOXS", "OOOOX", "OOOOO", "OOOOO", "EOOOO"]}

    test_input3 = {"maps": ["SELOX", "XXXXO", "OOOOO", "OXXXX", "OOOOO"]}

    test_input4 = {"maps": ["SXXOX", "EXXXL", "OOXOO", "OXXXX", "OOOOO"]}

    test_input5 = {"maps": ["SLXOX", "EXXXO", "OOOOO", "OXXXX", "OOOOO"]}
